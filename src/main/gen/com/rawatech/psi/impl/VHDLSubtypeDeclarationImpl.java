...
public class VHDLSubtypeDeclarationImpl extends ASTWrapperPsiElement implements VHDLSubtypeDeclaration {

  public VHDLSubtypeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
