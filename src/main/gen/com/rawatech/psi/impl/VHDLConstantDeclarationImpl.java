...
public class VHDLConstantDeclarationImpl extends ASTWrapperPsiElement implements VHDLConstantDeclaration {

  public VHDLConstantDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
