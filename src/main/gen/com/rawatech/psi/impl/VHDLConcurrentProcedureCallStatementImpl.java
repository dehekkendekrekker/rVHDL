...
public class VHDLConcurrentProcedureCallStatementImpl extends ASTWrapperPsiElement implements VHDLConcurrentProcedureCallStatement {

  public VHDLConcurrentProcedureCallStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitConcurrentProcedureCallStatement(this);
  }
