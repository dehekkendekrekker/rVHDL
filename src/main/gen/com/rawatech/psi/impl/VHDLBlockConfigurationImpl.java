...
public class VHDLBlockConfigurationImpl extends ASTWrapperPsiElement implements VHDLBlockConfiguration {
  ...
  @Override
  @NotNull
  public VHDLConfigurationItem getConfigurationItem() {
    return findNotNullChildByClass(VHDLConfigurationItem.class);
  }

  @Override
  @NotNull
  public VHDLUseClause getUseClause() {
    return findNotNullChildByClass(VHDLUseClause.class);
  }
