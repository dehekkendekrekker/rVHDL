...
public class VHDLVariableAssignmentStatementImpl extends ASTWrapperPsiElement implements VHDLVariableAssignmentStatement {

  public VHDLVariableAssignmentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
