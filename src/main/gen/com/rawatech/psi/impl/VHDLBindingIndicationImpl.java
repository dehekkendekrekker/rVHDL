...
public class VHDLBindingIndicationImpl extends ASTWrapperPsiElement implements VHDLBindingIndication {

  public VHDLBindingIndicationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitBindingIndication(this);
  }
  ...
  @Override
  @Nullable
  public VHDLEntityAspect getEntityAspect() {
    return findChildByClass(VHDLEntityAspect.class);
  }
