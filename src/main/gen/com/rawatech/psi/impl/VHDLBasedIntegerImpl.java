...
public class VHDLBasedIntegerImpl extends ASTWrapperPsiElement implements VHDLBasedInteger {

  public VHDLBasedIntegerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitBasedInteger(this);
  }
