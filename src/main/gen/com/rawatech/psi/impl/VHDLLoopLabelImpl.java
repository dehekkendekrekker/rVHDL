...
public class VHDLLoopLabelImpl extends ASTWrapperPsiElement implements VHDLLoopLabel {

  public VHDLLoopLabelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitLoopLabel(this);
  }
