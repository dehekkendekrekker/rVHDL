...
public class VHDLBlockHeaderImpl extends ASTWrapperPsiElement implements VHDLBlockHeader {

  public VHDLBlockHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitBlockHeader(this);
  }
