...
public class VHDLProcessLabelImpl extends ASTWrapperPsiElement implements VHDLProcessLabel {

  public VHDLProcessLabelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitProcessLabel(this);
  }
