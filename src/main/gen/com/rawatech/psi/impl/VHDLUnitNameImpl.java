...
public class VHDLUnitNameImpl extends ASTWrapperPsiElement implements VHDLUnitName {

  public VHDLUnitNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitUnitName(this);
  }
