...
public class VHDLParameterSpecificationImpl extends ASTWrapperPsiElement implements VHDLParameterSpecification {

  public VHDLParameterSpecificationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitParameterSpecification(this);
  }
