...
public class VHDLStringExpressionImpl extends ASTWrapperPsiElement implements VHDLStringExpression {

  public VHDLStringExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
