...
public class VHDLAssertionStatementImpl extends ASTWrapperPsiElement implements VHDLAssertionStatement {

  public VHDLAssertionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
