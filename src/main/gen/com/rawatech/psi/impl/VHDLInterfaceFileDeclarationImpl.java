...
public class VHDLInterfaceFileDeclarationImpl extends ASTWrapperPsiElement implements VHDLInterfaceFileDeclaration {

  public VHDLInterfaceFileDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitInterfaceFileDeclaration(this);
  }
