...
public class VHDLLabelelemImpl extends ASTWrapperPsiElement implements VHDLLabelelem {

  public VHDLLabelelemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitLabelelem(this);
  }
