...
public class VHDLInterfaceVariableDeclarationImpl extends ASTWrapperPsiElement implements VHDLInterfaceVariableDeclaration {

  public VHDLInterfaceVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
