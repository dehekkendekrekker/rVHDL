...
public class VHDLBlockDeclarativeItemImpl extends ASTWrapperPsiElement implements VHDLBlockDeclarativeItem {

  public VHDLBlockDeclarativeItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitBlockDeclarativeItem(this);
  }
  ...
  @Override
  @Nullable
  public VHDLConfigurationSpecification getConfigurationSpecification() {
    return findChildByClass(VHDLConfigurationSpecification.class);
  }
