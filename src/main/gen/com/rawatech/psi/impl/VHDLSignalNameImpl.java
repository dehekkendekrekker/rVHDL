...
public class VHDLSignalNameImpl extends ASTWrapperPsiElement implements VHDLSignalName {

  public VHDLSignalNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VHDLVisitor visitor) {
    visitor.visitSignalName(this);
  }
