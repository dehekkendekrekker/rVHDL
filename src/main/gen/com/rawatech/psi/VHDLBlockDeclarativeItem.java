...
public interface VHDLBlockDeclarativeItem extends PsiElement {
  ...
  @Nullable
  VHDLConfigurationSpecification getConfigurationSpecification();
  ...
  @Nullable
  VHDLSubprogramBody getSubprogramBody();
